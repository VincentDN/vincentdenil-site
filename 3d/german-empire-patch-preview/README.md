...
Depth is illustrative, not a supplied manufacturing specification: 2 mm backing, 0.8 mm panel relief, 0.85 mm medallion relief, 0.35 mm eagle relief and 0.15 mm shield relief (3.35 mm total maximum). Backing is smooth; stitch spacing and corner radii are illustrative. This is a visual prototype, not a mold-ready CAD solid.
